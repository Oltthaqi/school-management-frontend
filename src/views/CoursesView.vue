    ...
    >
      <div class="grid grid-cols-2 gap-4">
        <div>
          ...
          <p class="mt-1 text-sm text-gray-900">{{ viewingCourse.courseCode }}</p>
        </div>
        <div>
          <label class="block text-sm font-medium text-gray-700">Credit Hours</label>
          <p class="mt-1 text-sm text-gray-900">{{ viewingCourse.creditHours || 'N/A' }}</p>
        </div>
        ...
        <div class="col-span-2">
          ...
          <p class="mt-1 text-sm text-gray-900">{{ viewingCourse.description || 'N/A' }}</p>
        </div>
        <div class="col-span-2">
          <label class="block text-sm font-medium text-gray-700">Teacher</label>
          <p class="mt-1 text-sm text-gray-900">
            {{ viewingCourse.teacher.firstName }} {{ viewingCourse.teacher.lastName }}
